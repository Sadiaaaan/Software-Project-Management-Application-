	...
	<form method="POST" action="../../controller/Manager/checkDevAssign.php" enctype="">
		...
		<div align="center" class="welcome">Developer List</div>
				...
				<legend align="center">Assign a Developer</legend>
					<h4>Task ID:&ensp;&ensp;&ensp;&ensp;  <input type="text" id="taskid" name="taskid"></h4>
					<h4>Developer ID: <input type="text" id="empid" name="empid"></h4>
					<h4>Project Name: <input type="text" id="pname" name="pname"></h4>
